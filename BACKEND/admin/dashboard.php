...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>EDEN|| Admin Dashboard</title>
        <!-- App css -->
...
?>
                                                ...
                                                <div class="widget-chart-two-content">
                                                    <p class="text-muted mb-0 mt-2">Total Locations</p>
...
?>
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-xl-3">
                                            <div class="card-box mb-0 widget-chart-two">
                                                <div class="float-right">
<?php $queryPalmer=mysqli_query($con,"Select * from tbluser where ReferralCode='palmer'");
$palmercount=mysqli_num_rows($queryPalmer);
?>
                                                    <input data-plugin="knob" data-width="80" data-height="80" data-linecap=round
                                                           data-fgColor="#8e44ad" value="<?php echo $palmercount;?>" data-skin="tron" data-angleOffset="180"
                                                           data-readOnly=true data-thickness=".2"/>
                                                </div>
                                                <div class="widget-chart-two-content">
                                                    <p class="text-muted mb-0 mt-2">Referrals with Code 'palmer'</p>
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-xl-3">
                                            <div class="card-box mb-0 widget-chart-two">
                                                <div class="float-right">
<?php $queryCold=mysqli_query($con,"Select * from tbluser where ReferralCode='cold'");
$coldcount=mysqli_num_rows($queryCold);
?>
                                                    <input data-plugin="knob" data-width="80" data-height="80" data-linecap=round
                                                           data-fgColor="#3498db" value="<?php echo $coldcount;?>" data-skin="tron" data-angleOffset="180"
                                                           data-readOnly=true data-thickness=".2"/>
                                                </div>
                                                <div class="widget-chart-two-content">
                                                    <p class="text-muted mb-0 mt-2">Referrals with Code 'cold'</p>
