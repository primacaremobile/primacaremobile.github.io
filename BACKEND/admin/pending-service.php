...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>EDEN || PENDING SERVICES</title>
        <!-- App css -->
...
$ret=mysqli_query($con,"select tblservicerequest.ServiceNumber, tblservicerequest.ServiceLocation, tblservicerequest.ID as apid, tbluser.FullName,tbluser.MobileNo,tbluser.Email,tbluser.RegDate from  tblservicerequest inner join tbluser on tbluser.ID=tblservicerequest.UserId where tblservicerequest.AdminStatus is null");
$cnt=1;
